 ...
 */
class OurfruitController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Ourfruit models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new OurfruitSearch();
    ...
    /**
     * Updates an existing Ourfruit model.
    ...
    /**
     * Deletes an existing Ourfruit model.
